      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
        ...
        >
          ...
          <p className="text-gray-700 text-lg leading-relaxed max-w-xl">
            ...
            —এই মূলমন্ত্রে আমি শুধু নির্বাচিত হওয়ার জন্য নয়, সকল ধরনের দলীয় রাজনৈতিক এজেন্ডার বাইরে দাঁড়িয়ে, সাধারণ শিক্ষার্থীর অধিকার ও ন্যায়ের পক্ষে একটি অবিচল, সাহসী এবং জবাবদিহিতামূলক কণ্ঠস্বর হিসেবে কাজ করতে এসেছি। 
          </p>
